...
report 50007 "Edition Bon colisage"
{
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(SalesLine_NoColis; "Sales Shipment Line"."No. Colis")
                        {
                        }
            ...
            dataitem(Colis; Colis)
            {
                DataItemLink = "No. expedition" = field("No.");
                column(Colis_No; Colis."No.")
                {
                }
                column(Colis_Longueur_Cm; ZeroIsBlanckDecimal(Colis."Longueur (cm)"))
                {
                }
                column(Colis_Largeur_Cm; ZeroIsBlanckDecimal(Colis."Largeur (cm)"))
                {
                }
                column(Colis_Hauteur_Cm; ZeroIsBlanckDecimal(Colis."Hauteur (cm)"))
                {
                }
                column(Colis_Volume_M3; Colis."Volume (m3)")
                {
                }
                column(Colis_PoidsNet; ZeroIsBlanckDecimal(Colis."Poids net"))
                {
                }
                column(Colis_PoidsBrut; ZeroIsBlanckDecimal(Colis."Poids brut"))
                {
                }
                column(Colis_NbarticleColis; ZeroIsBlanckInteger(Colis."Nb piece dans le colis"))
                {
                }
                column(Colis_Nature; Colis."Nature du colis")
                {
                }
                column(Colis_Designation; Colis."Designation marchandise")
                {
                }
                ...
                trigger OnAfterGetRecord()
                begin
                    Colis.CALCFIELDS("Nb piece dans le colis");
                end;
            }
