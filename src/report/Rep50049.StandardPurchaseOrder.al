...
report 50049 "Standard Purchase - Order"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            begin
                ...
                //FIN DELPHI XAV
                //DEB DELPHI XAV 09/04/2018 Nø Devis
    ...
    var
        ...
        GTxtTotalPrice_Lbl: Label 'Total';
        GTxtBillAdresse_Lbl: Label 'Billing address';
        GTxtItemNo_Line_Lbl: Label 'Item No.';
        GTxtShipToAddress_Lbl: Label 'Delivery address';
