...
tableextension 50023 VATEntry extends "VAT Entry" //254
{
    ...
    //Unsupported feature: Code Modification on "CopyAmountsFromVATEntry(PROCEDURE 6)".
    ...
    //Unsupported feature: Code Modification on "SetUnrealAmountsToZero(PROCEDURE 7)".
